...
struct ProjectileEmitterComponent {
    ...
    ProjectileEmitterComponent(glm::vec2 projectile_velocity = glm::vec2(0),int repeat_frequency = 0,int projectile_duration = 10000,int hit_percent_damage = 10,bool is_friendly = false) {
